...
public class DialogActivity extends Activity{
    ...
    private void initView() {
        lhd_update_id_ok = (Button) findViewById(R.id.lhd_update_id_ok);
        tv_title = (TextView) findViewById(R.id.tv_title);
        lhd_update_id_cancel = (Button) findViewById(R.id.lhd_update_id_cancel);
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            if(forcedUpdate==1){
                Toast.makeText(DialogActivity.this, "请更新到最新版本！",
                ...
                if (!isDowning) {
                    ...
                    Toast.makeText(DialogActivity.this, "正在下载，请稍后！",
                            Toast.LENGTH_SHORT).show();
                    return false;
                }
            }
